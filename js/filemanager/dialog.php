...
<!DOCTYPE html>
<html xmlns="https://www.w3.org/1999/xhtml" id="CheckUploadAccessPage">
    <head>
	...
	<script>
        var data = {'dataLayer': '1'};
        jQuery.ajax({
	    url: "/site/checkUploadAccess",
	    type: "POST", dataType: 'JSON',data:data,
	    success: function(data) {
    	    if(data.success==false){
	       		$('#CheckUploadAccessPage').html("");
    	    }
	   }
       });
    </script>
	...
	<script>
	    ...
	    Dropzone.options.myAwesomeDropzone = {
		    ...
		    url: "upload.php?user_id=<?php echo $userId; ?>",
