...
(function($, Modernizr, image_editor) {
        ...
        makeContextMenu: function() {
            ...
            $.contextMenu({
                ...
                build: function($trigger) {
                    ...
                    if (
                        (
                            $trigger.find('.img-precontainer-mini .filetype').hasClass('png') || $trigger.find('.img-precontainer-mini .filetype').hasClass('jpg') || $trigger.find('.img-precontainer-mini .filetype').hasClass('jpeg')
                        ) && image_editor) {
    ...
    function fix_colums(adding) {
		...
		var uploaderLeftPropotion = 0.18;
		var deferredUploaderLeft = Math.floor(width * uploaderLeftPropotion);
		...
		var uploaderWidth = width + $('.breadcrumb').position().left - deferredUploaderLeft;
		
		uploader.css('left', deferredUploaderLeft);
        uploader.css('width', uploaderWidth);
