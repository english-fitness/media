...
// exit(isInLibrary($current_path . $parent) == true);
// echo isInLibrary($current_path . $parent) ? 'in library' : 'personal file';

if (isInLibrary($current_path . $parent)){
	require_once "config/publicLibraryConfig.php";
}else {
	$cycle = TRUE;
	$max_cycles = 50;
	$i = 0;
...
<body>
	...
	<input type="hidden" id="getContent" value="Copy to my documents" />
