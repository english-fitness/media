...
if (isset($_GET['action']))
{
    switch($_GET['action'])
    {
        ...
        case 'paste_clipboard':
			if (isInLibrary($path, $current_path)){
				response('This file or directory belongs to the public library. You are not permitted to perform the selected action on this file')->send();
				exit;
			}
