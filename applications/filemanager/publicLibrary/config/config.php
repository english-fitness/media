...
$upload_dir = '/media/uploads/shared/';
$current_path = '../../../uploads/shared/';
$own_dir = '../../../uploads/users/' . $userId . '/';
$library_folder = '../../shared/';

$thumbPath = '../../../thumbs/';

if (isset($_SESSION["RF"]["subfolder"]) && $_SESSION["RF"]["subfolder"] != null){
	$_SESSION["RF"]["subfolder"] = null;
}
...
$config = array(
	...
	*/
	...
	'copy_cut_files'                          => $copy_cut_files, // for copy/cut files
